...
<html class="no-js">
    ...
    <body>
      ...
      <div class="container">
          ...
          <div class="header">
            <h1 class="header-title">Bantuan mengenai Simpan dan kirim penawaran jasa Flex.</h1>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4 minHeight">
              ...
              <p>
                ...
                <br/>
                <img class="imageCharacter" src="../assets/images/sider_stepper/send_quotation_flex.png">
                <br/>
              </p>
            </div>
            <div class="col-md-4"></div>
