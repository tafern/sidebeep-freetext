...
<html class="no-js">
    <head>
        ...
        <title>Bantuan mengenai menjadi Sider</title>
    ...
    <body>
      ...
      <div class="container">
          ...
          <div class="header hidden-xs hidden-sm">
            <h1 class="header-title">Bantuan mengenai menjadi Sider.</h1>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4 minHeight">
              <h3 class="u-txt--xlarge u-txt--light">
                ...
                Menjadi Sider / Menjadi Penyedia Jasa
              </h3>
              <p>
                <br/>
                Setelah install aplikasi Sidebeep segera lakukan Registrasi.. 
                <br/>
                <img class="imageCharacter" src="../assets/images/sider_stepper/awal_menjadi_sider.png">
                <br/>
