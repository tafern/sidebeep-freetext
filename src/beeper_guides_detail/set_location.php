...
<html class="no-js">
    <head>
        ...
        <title>Bantuan mengenai tentukan lokasi pesan jasa</title>
        <meta name="description" content="Bantuan mengenai tentukan lokasi pesan jasa">
    ...
    <body>
      ...
      <div class="container">
          ...
          <!-- <div class="header">
            <h1 class="header-title">Bantuan mengenai tentukan lokasi pesan jasa.</h1>
          </div> -->
