...
<html class="no-js">
    ...
    <body>
      ...
      <div class="container">
          ...
          <div class="row">
            <div class="col-md-4 minHeight3">
              <h3 class="u-txt--xlarge u-txt--light">
                <div class="c-badge c-badge--large c-badge--yellow u-txt--xlarge u-align-center">1</div>
                Sidebeep
              </h3>
              <p>
                <img class="imageCharacter" src="assets/images/term_of_sidebeep/sidebeep.png">
                <br/>
                Sidebeep adalah aplikasi market place buatan Indonesia yang memberikan solusi kemudahan untuk para penyedia jasa gaya hidup (Sider) untuk dapat terhubung dengan pelanggan potensial jasa gaya hidup (Beeper).
                <br/>
              </p>
            </div>
            ...
            <div class="col-md-4 minHeight">
              ...
              <p>
                <img class="imageCharacter" src="assets/images/term_of_sidebeep/fix.png">
                <br/>
                <br/>
